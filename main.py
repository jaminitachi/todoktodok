...
class DebateBot:
    ...
    def evaluate_debate(self, chat_history):
        ...
        1. 주제의 일관성 (20점): 발언들이 주제에 부합하고 일관성이 있는가?
        2. 논리적 연결성 (20점): 발언들의 흐름과 논리적 연결성이 잘 유지되었는가?
        3. 반박의 적절성 (20점): 상대방의 주장을 이해하고 적절히 반박하였는가?
        4. 근거의 타당성 (20점): 주장에 대한 근거가 충분히 타당하고 논리적인가?
        5. 언어 선택의 적절성 (20점): 발언 과정에서 적절한 언어가 사용되었는가?
